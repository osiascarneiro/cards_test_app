...
data class CardContentButton(val title: String, val action: HomeAction) {

    companion object {
        fun fromMap(map: Map<String,Any>): CardContentButton {
            if(map.isEmpty()) return CardContentButton("", HomeAction("", emptyMap()))
            ...
            val action = HomeAction.fromMap(actionMap)
